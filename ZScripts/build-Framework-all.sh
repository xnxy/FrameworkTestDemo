...
#mkdir -p "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Versions/${FRAMEWORK_VERSION}/"
#mv "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/${PRODUCT_NAME}" "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Versions/${FRAMEWORK_VERSION}/"
#mv "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Headers" "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Versions/${FRAMEWORK_VERSION}/"
#mkdir -p "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Resources"
#declare -a UF_FILE_LIST
#list_files "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/" UF_FILE_LIST
#for file_name in "${UF_FILE_LIST[@]}"
#do
#if [[ "${file_name}" == "Info.plist" ]] || [[ "${file_name}" =~ .*\.lproj$ ]]
#then
#mv "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/${file_name}" "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Resources/"
#fi
#done
#mv "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Resources" "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Versions/${FRAMEWORK_VERSION}/"
#ln -sfh "Versions/Current/Resources/Info.plist" "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Info.plist"
#ln -sfh "${FRAMEWORK_VERSION}" "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Versions/Current"
#ln -sfh "Versions/Current/${PRODUCT_NAME}" "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/${PRODUCT_NAME}"
#ln -sfh "Versions/Current/Headers" "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Headers"
#ln -sfh "Versions/Current/Resources" "${UNIVERSAL_OUTPUTFOLDER}/${PRODUCT_NAME}.framework/Resources"
### Copy framework to tpbuild/framework
